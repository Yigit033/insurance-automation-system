...
DROP FUNCTION IF EXISTS search_documents(UUID, TEXT, TEXT, TIMESTAMP WITH TIME ZONE, TIMESTAMP WITH TIME ZONE);
DROP FUNCTION IF EXISTS get_user_analytics(UUID);

-- Recreate search function with proper search path
...
-- Recreate analytics function with proper search path

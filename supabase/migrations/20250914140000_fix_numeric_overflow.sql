...
-- Change ocr_confidence from DECIMAL(5,2) to DECIMAL(6,2) to allow values up to 9999.99
ALTER TABLE public.documents 
ALTER COLUMN ocr_confidence TYPE DECIMAL(6,2);

-- Change confidence in document_fields from DECIMAL(5,2) to DECIMAL(6,2)
ALTER TABLE public.document_fields 
ALTER COLUMN confidence TYPE DECIMAL(6,2);

-- Update the search function to use the new precision
...
-- Update the analytics function to use the new precision
